...
from flow.nets_multi_x import se_equivariant_net, HConfig, MultiEgnnConfig
...
def test_equivariant_fn(dim: int = 2, n_nodes: int = 8, batch_size: int = 3):
    ...
    eggn_config = MultiEgnnConfig(name='egnn', n_heads=2, mlp_units=(16,), identity_init_x=False, n_layers=2,
    ...
    x_out_transformed = jax.vmap(rotate_translate_2d)(x_out, theta, shift)

...
from examples.download_checkpoint import download_checkpoint
...
from eacf.train.fab_train_no_buffer import TrainStateNoBuffer
...
def download_checkpoint_and_eval(problem, seed, flow_type):
    ...
    checkpoint_path = f"examples/dw4_results/models/{flow_type}_seed{seed}.pkl"

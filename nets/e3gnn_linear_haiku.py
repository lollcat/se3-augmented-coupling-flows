...
from e3nn_jax._src.linear import FunctionalLinear, linear_indexed, linear_mixed, linear_mixed_per_channel, \
    linear_vanilla
        ...
        *,
        ...
        if get_parameter is None:
            ...
            def get_parameter(name: str, path_shape: Tuple[int, ...], weight_std: float,
                ...
                initializer = jnp.zeros if name[0] == "b" else hk.initializers.RandomNormal(stddev=weight_std)
